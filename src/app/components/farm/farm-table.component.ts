...
export class FarmTableComponent implements OnInit, OnDestroy, AfterViewInit {
  separatorKeysCodes: number[] = [ENTER, COMMA];
  @Input() farmTableForm: FormGroup = new FormGroup({});

  constructor(private formBuilder: FormBuilder) {}

  ngOnInit() {
    if (!this.farmTableForm) {
      this.initForm();
    }
  }
  ...
  initForm() {
    this.farmTableForm = this.formBuilder.group({});
  }
}
