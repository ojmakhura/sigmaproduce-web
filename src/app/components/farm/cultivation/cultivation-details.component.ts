...
@Component({
  selector: "app-cultivation-details",
...
export class CultivationDetailsComponent implements OnInit, OnDestroy, AfterViewInit {

    separatorKeysCodes: number[] = [ENTER, COMMA];
    @Input() cultivationDetailsForm: FormGroup = new FormGroup({});
    ...
    ngOnInit() {
        if(!this.cultivationDetailsForm) {
            this.initForm();
        }
    }
    ...
    initForm() {
        this.cultivationDetailsForm = this.formBuilder.group({
    ...
    get idControl(): FormControl {
        return this.cultivationDetailsForm?.get('id') as FormControl;
    }


    get createdByControl(): FormControl {
        return this.cultivationDetailsForm?.get('createdBy') as FormControl;
    }


    get updatedByControl(): FormControl {
        return this.cultivationDetailsForm?.get('updatedBy') as FormControl;
    }


    get createdDateControl(): FormControl {
        return this.cultivationDetailsForm?.get('createdDate') as FormControl;
    }


    get updatedDateControl(): FormControl {
        return this.cultivationDetailsForm?.get('updatedDate') as FormControl;
    }


    get farmControl(): FormGroup {
        return this.cultivationDetailsForm?.get('farm') as FormGroup;
    }
    ...
    get cropVarietyControl(): FormGroup {
        return this.cultivationDetailsForm?.get('cropVariety') as FormGroup;
    }
    ...
    get cultivationDateControl(): FormControl {
        return this.cultivationDetailsForm?.get('cultivationDate') as FormControl;
    }


    get exptectedHarvestDateControl(): FormControl {
        return this.cultivationDetailsForm?.get('exptectedHarvestDate') as FormControl;
    }


    get sizeControl(): FormControl {
        return this.cultivationDetailsForm?.get('size') as FormControl;
    }


    get unitControl(): FormGroup {
        return this.cultivationDetailsForm?.get('unit') as FormGroup;
    }
