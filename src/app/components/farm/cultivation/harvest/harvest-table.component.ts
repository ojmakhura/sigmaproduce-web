...
export class HarvestTableComponent implements OnInit, OnDestroy, AfterViewInit {
  separatorKeysCodes: number[] = [ENTER, COMMA];
  @Input() harvestTableForm: FormGroup = new FormGroup({});

  constructor(private formBuilder: FormBuilder) {}

  ngOnInit() {
    if (!this.harvestTableForm) {
      this.initForm();
    }
  }
  ...
  initForm() {
    this.harvestTableForm = this.formBuilder.group({});
  }
}
