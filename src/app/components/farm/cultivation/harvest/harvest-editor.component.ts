...
@Component({
  selector: "app-harvest-editor",
  templateUrl: "./harvest-editor.component.html",
  styleUrls: [],
  standalone: true,
  imports: [
    CommonModule,
...
export class HarvestEditorComponent implements OnInit, OnDestroy, AfterViewInit {

    separatorKeysCodes: number[] = [ENTER, COMMA];
    @Input() harvestEditorForm: FormGroup = new FormGroup({});
    ...
    cultivationFarmModalColumns = [
        'actions',
    ];
    @ViewChild('cultivationCropVarietyModalPaginator', {static: true}) cultivationCropVarietyModalPaginator: MatPaginator;
    ...
    cultivationCropVarietyModalColumns = [
        'actions',
    ];
    ...
    initForm() {
        this.harvestEditorForm = this.formBuilder.group({
    ...
    get idControl(): FormControl {
        return this.harvestEditorForm?.get('id') as FormControl;
    }


    get createdByControl(): FormControl {
        return this.harvestEditorForm?.get('createdBy') as FormControl;
    }


    get updatedByControl(): FormControl {
        return this.harvestEditorForm?.get('updatedBy') as FormControl;
    }


    get createdDateControl(): FormControl {
        return this.harvestEditorForm?.get('createdDate') as FormControl;
    }


    get updatedDateControl(): FormControl {
        return this.harvestEditorForm?.get('updatedDate') as FormControl;
    }


    get quantityControl(): FormControl {
        return this.harvestEditorForm?.get('quantity') as FormControl;
    }


    get unitControl(): FormGroup {
        return this.harvestEditorForm?.get('unit') as FormGroup;
    }


    get imagesControl(): FormArray {
        return this.harvestEditorForm?.get('images') as FormArray;
    }
    ...
    get cultivationControl(): FormGroup {
        return this.harvestEditorForm?.get('cultivation') as FormGroup;
    }
