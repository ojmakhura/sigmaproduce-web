...
@Component({
  selector: "app-crop-type-details",
  templateUrl: "./crop-type-details.component.html",
  styleUrls: [],
  standalone: true,
  imports: [
    CommonModule,
...
export class CropTypeDetailsComponent implements OnInit, OnDestroy, AfterViewInit {

    separatorKeysCodes: number[] = [ENTER, COMMA];
    @Input() cropTypeDetailsForm: FormGroup = new FormGroup({});
    ...
    initForm() {
        this.cropTypeDetailsForm = this.formBuilder.group({
    ...
    get idControl(): FormControl {
        return this.cropTypeDetailsForm?.get('id') as FormControl;
    }


    get createdByControl(): FormControl {
        return this.cropTypeDetailsForm?.get('createdBy') as FormControl;
    }


    get updatedByControl(): FormControl {
        return this.cropTypeDetailsForm?.get('updatedBy') as FormControl;
    }


    get createdDateControl(): FormControl {
        return this.cropTypeDetailsForm?.get('createdDate') as FormControl;
    }


    get updatedDateControl(): FormControl {
        return this.cropTypeDetailsForm?.get('updatedDate') as FormControl;
    }


    get codeControl(): FormControl {
        return this.cropTypeDetailsForm?.get('code') as FormControl;
    }


    get nameControl(): FormControl {
        return this.cropTypeDetailsForm?.get('name') as FormControl;
    }


    get imagesControl(): FormArray {
        return this.cropTypeDetailsForm?.get('images') as FormArray;
    }
    ...
    get descriptionControl(): FormControl {
        return this.cropTypeDetailsForm?.get('description') as FormControl;
    }


    get numberOfCropsControl(): FormControl {
        return this.cropTypeDetailsForm?.get('numberOfCrops') as FormControl;
    }


    get numberOfDiseasesControl(): FormControl {
        return this.cropTypeDetailsForm?.get('numberOfDiseases') as FormControl;
    }


    get numberOfPestsControl(): FormControl {
        return this.cropTypeDetailsForm?.get('numberOfPests') as FormControl;
    }
