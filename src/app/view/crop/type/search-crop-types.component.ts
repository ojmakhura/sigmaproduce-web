...
export abstract class SearchCropTypesComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('searchCropTypesCropTypesComponent')
  searchCropTypesCropTypesComponent?: SearchCropTypesCropTypesImplComponent;
  ...
  ngOnInit() {
    ...
    this.searchCropTypesFormValueSubscription = this.searchCropTypesForm.valueChanges.subscribe((change: any) => {
